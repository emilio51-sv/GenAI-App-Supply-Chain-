...
<div style="text-align:center;">
    <h1 style="color:#4A90E2; font-size: 3em; margin-bottom: 0.2em;">🌌 Samsung Galaxy S24 Ultra Supply Chain Simulator</h1>
    <p style="font-size:1.2em; color:#444;">
       Experience a dynamic simulation of Samsung's Galaxy S24 Ultra supply chain under crisis conditions.
       Multiple specialized agents—each tasked with a crucial function, from component manufacturing to global distribution—
       collaborate in a sequential workflow. Monitor how they analyze disruptions, communicate critical bottlenecks, and implement real-time strategies 
       to ensure a steady supply of devices worldwide. This end-to-end simulation offers an in-depth look at how a modern tech supply chain identifies, 
       navigates, and resolves complex issues to maintain production continuity and customer satisfaction.
    </p>
</div>
...
if run_simulation:
    ...
    # ------------------------------------
    # STEP 2: PRODUCTION & LOGISTICS TASKS
    # ------------------------------------
    ...
    # --------------------------------------------------
    # STEP 3: SUMMARY AGENT TASK (COLLECT ALL AGENTS' OUTPUTS)
    # --------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # SHOW PRODUCTION AND LOGISTICS REPORTS (WHICH INCLUDE CRISIS ANALYST + OTHERS)
    # -------------------------------------------------------------------------
    ...
    # TABS FOR EACH AGENT (INCLUDING CRISIS ANALYST)
